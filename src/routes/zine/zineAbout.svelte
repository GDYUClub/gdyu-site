        ...
        <div class="w-10/12">
            ...
            <div class="flex gap-4 flex-wrap mt-10 justify-center">
                <div class="zineCard w-96 flex flex-col">
                    ...
                    <img class="w-1/2 mx-auto py-8 mt-auto" src="{base}/assets/tabs.svg" alt="">
                </div>
                <div class="zineCard w-96 flex flex-col">
                    ...
                    <img class="w-1/2 mx-auto py-8 mt-auto" src="{base}/assets/pages.svg" alt="">
                </div>
                <div class="zineCard w-96 flex flex-col">
                    ...
                    <img class="w-1/2 mx-auto py-8 mt-auto" src="{base}/assets/windows.svg" alt="">
                </div>
            </div>
        </div>

<div class="dark w-full">
    ...
    <div class="flex h-20 ml-10">
        <div class="pinkText blockTopText my-auto">ABOUT</div>
    </div>
    ...
    <div class="flex">
        ...
        <div class="w-10/12">
            ...
            <div class="flex gap-4 flex-wrap mt-10 justify-center">
                <div class="flashCard w-96 flex flex-col">
                    ...
                    <img class="w-1/2 mx-auto py-4" src="assets/tabs.svg" alt="">
                </div>
                <div class="flashCard w-96 flex flex-col">
                    ...
                    <img class="w-1/2 mx-auto py-4 mt-auto" src="assets/pages.svg" alt="">
                </div>
                <div class="flashCard w-96 flex flex-col">
                    ...
                    <img class="w-1/2 mx-auto py-4 mt-auto" src="assets/windows.svg" alt="">
                </div>
            </div>
        </div>
